...
// Suppress known benign AudioContext errors from Howler.js (closed audio context).
// capture:true runs BEFORE the Replit runtime-error-modal plugin's bubble listener.
// stopImmediatePropagation prevents the error modal from ever receiving the event.
