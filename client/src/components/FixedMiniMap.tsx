...
export function FixedMiniMap() {
  ...
  return (
    <div className="bg-gray-900/90 border border-cyan-400/50 rounded-lg p-2">
      <div className="text-cyan-400 text-xs font-mono mb-1 text-center">NAV MAP</div>
      <div 
      ...
      >
        ...
        <svg className="absolute inset-0 w-full h-full">
          <defs>
            <pattern id="space-grid-fixed" width="20" height="20" patternUnits="userSpaceOnUse">
              <path d="M 20 0 L 0 0 0 20" fill="none" stroke="rgba(6, 182, 212, 0.2)" strokeWidth="0.5"/>
            </pattern>
          </defs>
          <rect width="100%" height="100%" fill="url(#space-grid-fixed)" />
        </svg>
