                    ...
                    <div className="grid grid-cols-2 gap-3">
                        ...
                        >
                            <div className="flex flex-col items-center gap-2">
                                <div
                                    className="w-full h-16 rounded bg-gradient-to-br from-slate-700 to-slate-800 border border-cyan-500/50 flex items-center justify-center">
                        ...
                        >
                            <div className="flex flex-col items-center gap-2">
                                <div
                                    className="w-full h-16 rounded bg-gradient-to-br from-black to-gray-900 border border-white/50 flex items-center justify-center">
