      ...
      {showMessage && (
        ...
        >
          ...
          >
            ...
            `}
            />
            {hasFocus ? "Controls Active" : "Click Game to Enable Controls"}
          </div>
        </motion.div>
      )}
    </AnimatePresence>
...
export function FocusStatusIndicator() {
  ...
  return (
    <div className="fixed top-20 right-1/2 z-40">
      <motion.div
        animate={{
      ...
      >
        <div
          ...
          ${hasFocus ? "bg-green-400 animate-pulse" : "bg-red-400 animate-ping"}
        `}
        />
