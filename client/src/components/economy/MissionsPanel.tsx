...
export function MissionsPanel() {
  ...
  const [selectedChoice, setSelectedChoice] = useState<MissionChoice | null>(
    null,
  );
  ...
  useEffect(() => {
    ...
    gameFacade.initialize().then(() => {
      console.log(
        "[MissionsPanel] GameFacade initialized, missions should be generated",
      );
    });
  ...
  const checkMissionAvailability = (mission: Mission) => {
    ...
    if (
      ...
      credits < mission.requirements.credits
    ) {
  ...
  const getMissionAvailabilityColor = (mission: Mission) => {
    ...
    if (availability.close)
      return "bg-yellow-900/20 border-yellow-600/50 opacity-90";
  ...
  const handleMissionChoice = async (
    mission: Mission,
  ...
  const renderObjective = (objective: MissionObjective, missionId: string) => {
    const progress =
      plunderverseMissions.currentObjectiveProgress
        .get(missionId)
        ?.get(objective.id) || 0;
    ...
    return (
      <div key={objective.id} className="flex items-center space-x-2 text-xs">
        <span
          className={objective.completed ? "text-green-400" : "text-gray-400"}
        >
          {objective.completed ? "✅" : "⭕"}
        </span>
        <span
          className={`flex-1 ${objective.completed ? "line-through text-gray-500" : "text-gray-300"}`}
        >
  ...
  const renderMissionCard = (mission: Mission, isActive: boolean = false) => {
    ...
    const availability = checkMissionAvailability(mission);
    const availabilityStyle = isStoryMission
      ? ""
      : getMissionAvailabilityColor(mission);
    ...
    return (
      ...
      >
        ...
        {!availability.available && !isStoryMission && (
          <div
            className={`absolute top-0 left-0 right-0 px-2 py-1 text-xs font-medium text-center ${
              availability.close
        ...
        <div
          className={`flex items-start justify-between mb-2 ${!availability.available && !isStoryMission ? "mt-6" : ""}`}
        >
          <div className="flex items-center space-x-2">
            ...
            <h3
              className={`font-semibold ${isStoryMission ? "text-purple-200" : "text-white"}`}
            >
              {mission.title}
            </h3>
        ...
        {mission.rewards?.base?.reputation && (
          <div className="flex items-center space-x-2 text-xs">
            ...
            {Object.entries(mission.rewards.base.reputation).map(
              ([faction, change]) => (
                <span
                  key={faction}
  ...
  return (
    <>
      <div className="space-y-3">
        ...
        <div className="missions-panel-header bg-gray-800 p-4 border-b border-gray-600 rounded-t-lg">
          ...
          <div className="grid grid-cols-4 gap-2 text-xs">
            ...
            <div className="text-center">
              <div
                className={`font-mono text-lg ${player.notoriety > 50 ? "text-purple-400" : "text-gray-400"}`}
              >
                😈 {player.notoriety}
              </div>
            ...
            <div className="text-center">
              <div
                className={`font-mono text-lg ${player.heat > 50 ? "text-red-400" : player.heat > 20 ? "text-orange-400" : "text-green-400"}`}
              >
                🚨 {player.heat}
              </div>
          ...
          {activeTab === "plunderverse" && (
            <>
              ...
              {plunderverseMissions.availableMissions.length === 0 ? (
                <div className="text-center py-8">
                  ...
                  <button
                    onClick={() => {
                      ...
                      plunderverseMissions.generateMissions(
                        "Earth",
                        player.rank,
                        seed,
                      );
                ...
                plunderverseMissions.availableMissions.map((mission) =>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-800 p-3 rounded border border-gray-600">
                ...
                <div className="grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span
                      className={
                        gameFacade.canAccessBlackMarket()
                          ? "text-green-400"
                          : "text-red-400"
                      }
                    >
              ...
              <div className="bg-gray-800 p-4 rounded border border-gray-600">
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Law-abiding mega-corporations. High security, good pay,
                    strict rules.
                  </p>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-400 mt-1">
                    Free settlers and traders. Flexible morals,
                    community-minded.
                  </p>
                </div>
              ...
              <div className="bg-gray-800 p-3 rounded border border-gray-600">
                ...
                <div className="space-y-1 text-xs text-gray-400">
                  <div>
                    • High corporate rep: Better prices at stations, access to
                    restricted areas
                  </div>
                  <div>
                    • High independent rep: More diverse missions, community
                    support
                  </div>
                  <div>
                    • High outlaw rep: Black market access, intimidation bonus
                  </div>
                  <div>
                    • Low reputation: Higher prices, fewer opportunities,
                    possible hostility
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800 p-3 rounded border border-gray-600">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span
                      className={
                        player.heat > 50 ? "text-red-400" : "text-orange-400"
                      }
                    >
                      {player.heat}/100
                    </span>
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-purple-400">
                      {plunderverseMissions.completedMissionIds.size +
      ...
      {selectedMission && (
        ...
        >
          <div
            className="bg-gray-900 border border-gray-600 rounded-lg p-6 max-w-2xl w-full mx-4 max-h-[80vh] overflow-y-auto"
          ...
          >
            ...
            {selectedMission.choices && selectedMission.choices.length > 0 && (
              <div className="mb-4">
                ...
                <p className="text-xs text-gray-400">
                  Your decisions will impact faction relationships and future
                  opportunities
                </p>
              </div>
            )}
            ...
            {selectedMission.requirements &&
              Object.keys(selectedMission.requirements).length > 0 && (
                <div className="mb-4">
                  <h3 className="text-sm font-bold text-white mb-2">
                    Requirements:
                  </h3>
                  <div className="text-sm text-gray-400">
                    {selectedMission.requirements.credits && (
                      <div>
                        • Credits: {selectedMission.requirements.credits}
                      </div>
                    )}
                    {selectedMission.requirements.reputation &&
                      Object.entries(
                        ...
                        <div key={faction}>
                          • {faction} reputation: {req}
                        </div>
                      ))}
                    {selectedMission.requirements.cargoSpace && (
                      <div>
                        • Cargo space: {selectedMission.requirements.cargoSpace}
                      </div>
                    )}
                  </div>
                </div>
            ...
            <div className="mb-4">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                <div>
                  ...
                  {(selectedMission.type === "smuggling" ||
                    selectedMission.type === "bounty") && (
      ...
      {showChoiceDialog &&
        selectedMission &&
        selectedMission.choices.length > 0 && (
          <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
            <div className="bg-gray-900 border border-purple-600 rounded-lg p-6 max-w-2xl w-full mx-4">
              ...
              <p className="text-gray-300 mb-4 italic">
                Choose carefully - your decision will have lasting
                consequences...
              </p>
